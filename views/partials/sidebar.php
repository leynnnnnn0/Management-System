        ...
        <ul class="flex flex-col py-4">
            ...
            <li>
                <a href="/schoolmanagementsystem/index.php/teachers" class="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-white hover:text-gray-800">
                    <span class="inline-flex items-center justify-center h-12 w-12 text-lg <?= urlIs("/schoolmanagementsystem/index.php/teachers") || urlIs("/schoolmanagementsystem/index.php/teachers/add") ? "text-gray-800" : "text-white" ?>"><i class="bi bi-briefcase"></i></i></span>
                    <span class="text-sm font-medium <?= urlIs("/schoolmanagementsystem/index.php/teachers") || urlIs("/schoolmanagementsystem/index.php/teachers/add") ? "text-gray-800" : "text-white" ?>">Teachers</span>
                </a>
            </li>
            <li>
